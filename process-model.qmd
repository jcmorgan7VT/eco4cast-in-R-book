...
I have provided a custom function to access the weater drivers. You can learn more about the function in the appendix (add link).  They are provided in the chapter as a function rather than the full code to avoid unncessary detraction from the focus on the process model.
...
Here is a plot of the meterological input data.

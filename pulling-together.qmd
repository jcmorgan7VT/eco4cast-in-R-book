...
#| warning: false
#| echo: false
#| fig-cap: Post-analysis predictions from the forest model (median and 90% CI) with data assimilation using the particle filter. Observations used in data assimilation are denoted as red dots.
output_df |> 

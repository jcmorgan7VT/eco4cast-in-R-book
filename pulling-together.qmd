...
```{r}
inputs_past <- get_historical_met(site = "TALL", sim_dates[1:(look_back-1)], use_mean = FALSE)
inputs_future <- get_forecast_met(site = "TALL", sim_dates[look_back:length(sim_dates)], use_mean = FALSE)

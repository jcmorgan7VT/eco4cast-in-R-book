...
2.  Complete activities A and B in the [Rmarkdown document](https://github.com/MacrosystemsEDDIE/module6_R/blob/main/assignment/module6.Rmd). You will be modifying the Rmarkdown document with the answers to the questions (both text and code).  Activity C is part of @sec-second-forecast

...
This chapter sets the foundation for @sec-second-forecast.  In @sec-second-forecast, you will use code and concepts in this chapter to add uncertainty to your forecast from @sec-first-forecast.

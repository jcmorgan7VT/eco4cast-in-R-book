...
[Assignment Rmarkdown](https://github.com/OlssonF/NEON-forecast-challenge-workshop/blob/main/Analyse_scores/Get_scores_tutorial.Rmd)
...
Importantly, we use the convention for CRPS where zero is lowest and best possible score, therefore teams want to achieve the lowest score. CPRS can be also expressed as a negative number with zero as highest and best possible score (@gneitingStrictlyProperScoring2007). The `scoringRules` package that we use follows the 0 or greater convention.

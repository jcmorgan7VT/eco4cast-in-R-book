...
This chapter applies the concepts in Chapter 5: Understanding Uncertainty in Ecological Forecasts to the forest process model.  If you have not reviewed chapter 5 yet, I recommend doing that  as a foundation for this Chapter.
...
**TO DO: Add text about where parameter uncertainty comes from**
...
**TO DO: Add text about where process uncertainty comes from.  Priors, experts, posteriors, estimated distributions**
...
The spread that is added to each leaves at each time step.
...
**TO DO: Add text about where initial condition uncertainty comes from**
...
The spread in leaves at the first time-step.
...
**TO DO: Add text about where driver uncertainty comes from**
...
Uncertainty in the weather forecasts 

...
2. Work through the tutorial into TASKS sections
3. Modify the simple model in the template Rmd in some way (see TASKS for ideas).
4. Knit the template Rmd to html.
5. Commit template to GitHub

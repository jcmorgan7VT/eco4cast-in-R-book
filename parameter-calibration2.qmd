...
Your task is to modify the code below to estimate the posterior distribution of parameters in Q10 function that was in the likelihood analysis exercise (@sec-q10). Use the same data as used in the Q10 likelihood exercise.

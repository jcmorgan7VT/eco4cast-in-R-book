...
The book is a near-term iterative forecast itself. It automatically rebuilds every day using GitHub actions. Each build accesses the latest NEON data, NOAA weather forecasts, assimilated data, generates a new forecast of daily net ecosystem exchange (NEE) for one NEON site (TALL). The forecast is submitted to the NEON Ecological Forecasting Challenge.

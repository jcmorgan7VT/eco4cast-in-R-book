...
The book uses R code to teach concepts by example (hence the name "A practical guide...") . Hopefully the code provides an mechanism for developing your intuition through examples.

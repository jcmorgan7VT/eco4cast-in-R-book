...
Here is an example of the particle filter applied to the [Google Flu data](https://en.wikipedia.org/wiki/Google_Flu_Trends), project that has been since stoped by Google due to accuracy issues.  It is still a good dataset for illustrative purposes here.
